(ns toritate.methods.imputed-income
  ...
  Reads `wire/valuation/v1-retail-equiv.json` (the open, method-versioned, Council-attestable
...
;; Mirrors wire/contracts/toritate/ledgerEntry.json knownValues exactly
...
#?(:clj
   (defn- default-valuation-file []
     (io/file "wire" "valuation" "v1-retail-equiv.json")))
